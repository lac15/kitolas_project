...
public class KitolasData {
	...
	/**
	 * @param tablanB Beállítja a paraméterként kapott értékre a
	 * táblán lévő fekete kavicsok számát.
	 */
	...
	/**
	 * @param levettB Beállítja a paraméterként kapott értékre a
	 * levett fekete kavicsok számát.
	 */
	...
	/**
	 * @param tablanW Beállítja a paraméterként kapott értékre a
	 * táblán lévő fehér kavicsok számát a táblán.
	 */
	...
	/**
	 * @param levettW Beállítja a paraméterként kapott értékre a
	 * levett fehér kavicsok számát.
	 */
	...
	/**
	 * @param korSzam Baállítja a paraméterként kapott értékre az
	 * eltelt körök számát.
	 */
	 ...
	 * @param tabla Egy 6x6 dimenziós mátrix.
	 */
	...
	/**
	 * @return Visszaad egy 6x6-os mátrixok melyben a táblán lévő
	 * elemek vannak.
	 */
	public int[][] getTabla() {
		return tabla;
	...
	/**
	 * Beállítja a paraméterként kapott mátrixra a táblán lévő
	 * elemek mátrixát.
	 * @param tabla Egy 6x6 dimenziós mátrix.
	 */
	 ...
	 * @return A táblán lévő elemek mátrixának (x,y) helyén található
	 * elemet adja vissza.
	 */
	...
	/**
	 * Beállitja a táblán lévő elemek mátrixának (x,y) helyén lévő
	 * elemét a paraméterként kapott value értékre.
	 * @param x A táblán lévő elemek mátrixának sor indexe.
	 * @param y A táblán lévő elemek mátrixának oszlop indexe.
	 * @param value A táblán lévő elemek mátrixának (x,y) helyére
	 * kerülő új elem.
	 */
